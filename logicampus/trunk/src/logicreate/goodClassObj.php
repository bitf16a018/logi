 ...
 **/
			...
			LEFT JOIN profile_faculty on profile_faculty.username=profile.username
				...
				AND css.active = 1
				AND semesters.dateStudentActivation < ".DB::getFuncName('".DB::getFuncName('NOW()')."')."
				AND semesters.dateDeactivation > ".DB::getFuncName('".DB::getFuncName('NOW()')."')."
		";		
...
and semesters.dateAccountActivation < ".DB::getFuncName('".DB::getFuncName('NOW()')."')."
and semesters.dateDeactivation > ".DB::getFuncName('".DB::getFuncName('NOW()')."')."
";
		$db->query($sql);
		$db->RESULT_TYPE=MYSQL_ASSOC;
