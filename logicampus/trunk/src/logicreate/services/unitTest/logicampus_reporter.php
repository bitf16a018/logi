<?php
	 ...
	 *	  @subpackage UnitTester
     */
    class LcHtmlReporter extends SimpleReporter {
        var $_character_set;
         ...
         *    @access public
         */
        function LcHtmlReporter($character_set = 'ISO-8859-1') {
            $this->SimpleReporter();
	    ...
	    foreach ($this->passfailtrail as $section => $fileStruct) {
			...
			echo "\t\t<tr><td width=\"50%\" valign=\"top\" rowspan=\"".(count($funcStruct)+1)."\">".$file." -&gt; ".$class."</td><td>passed / failed</td><td>Test</td></tr>\n";
				...
				$link = '<a href="'.appurl('unitTest/main/event=inspect/m=unitTest/s='.$this->service.'/#'.$func).'">'. $func.'</a>';
